...
return t&&(
// Increase count
r++,e.set({count:r})),r}),t=e=>t=>{e.innerText=t};document.addEventListener("page:loaded",()=>{const o=firebase.firestore().collection(CONFIG.firestore.collection);if(CONFIG.page.isPost){
// Fix issue #118
